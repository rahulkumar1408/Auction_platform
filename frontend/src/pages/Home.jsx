...
const Home = () => {
  ...
  return (
    <>
      <section className="w-94% ml-0 m-0 h-fit px-5 pt-20 lg:pl-[320px] flex flex-col min-h-screen py-4 justify-center">
        <div>
          <p className="text-[#DECCBE] font-bold text-xl mb-8">
            Transparency Leads to Your Victory
          </p>
          <h1
            className={`text-[#111] text-2xl font-bold mb-2 min-[480px]:text-4xl md:text-6xl xl:text-7xl 2xl:text-6xl`}
          >
            Transparent Auctions
          </h1>
          <h1
            className={`text-[#d6482b] text-2xl font-bold mb-2 min-[480px]:text-4xl md:text-6xl xl:text-7xl 2xl:text-6xl`}
          >
            Be The Winner
          </h1>
        ...
        <div className="flex flex-col gap-6">
          ...
          <div className="flex flex-col gap-3 md:flex-row md:flex-wrap w-full">
